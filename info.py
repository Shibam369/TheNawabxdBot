...
BOT_TOKEN = environ.get('BOT_TOKEN', "6751450675:AAEjvnPrqVwjW6-6LA2Hz0F1QhMDP9Iuzv0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037738117')) #Log channel id ( make sure bot is admin )
